import { fieldsUser, fieldsProject, fieldsNezam } from "./fieldsConfig";
...
export const openDB = () => {
  return new Promise((resolve, reject) => {
    ...
    request.onupgradeneeded = (event) => {
      ...
      const createStore = (storeName, fields) => {
        if (!dbInstance.objectStoreNames.contains(storeName)) {
          ...
          fields.forEach((field) => {
            ...
            if (
              ...
              store.createIndex(field.key, field.key, { unique: false });
              console.log(
      ...
      createStore("projects_basic", fieldsUser);
      createStore("projects_details", fieldsProject);
      createStore("projects_status", fieldsNezam);
    };
